...
static void tci_write_reg(tcg_target_ulong *regs, TCGReg index,
...
#if TCG_TARGET_REG_BITS == 64
static void tci_write_reg32s(tcg_target_ulong *regs, TCGReg index,
                             int32_t value)
{
...
static void tci_write_reg16(tcg_target_ulong *regs, TCGReg index,
                            uint16_t value)
{
    tci_write_reg(regs, index, value);
}

static void tci_write_reg32(tcg_target_ulong *regs, TCGReg index,
                            uint32_t value)
{
    tci_write_reg(regs, index, value);
}
...
static void tci_write_reg64(tcg_target_ulong *regs, TCGReg index,
                            uint64_t value)
{
    tci_write_reg(regs, index, value);
}
...
static tcg_target_ulong tci_read_r(const tcg_target_ulong *regs,
                                   uint8_t **tb_ptr)
{
...
static target_ulong tci_read_ulong(const tcg_target_ulong *regs,
                                   uint8_t **tb_ptr)
{
...
static tcg_target_ulong tci_read_ri(const tcg_target_ulong *regs,
                                    uint8_t **tb_ptr)
{
    tcg_target_ulong value;
    TCGReg r = **tb_ptr;
...
#define qemu_ld_ub helper_ret_ldub_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_ld_leuw helper_le_lduw_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_ld_leul helper_le_ldul_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_ld_leq helper_le_ldq_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_ld_beuw helper_be_lduw_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_ld_beul helper_be_ldul_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_ld_beq helper_be_ldq_mmu(env, taddr, oi, (uintptr_t)tb_ptr)
#define qemu_st_b(X) helper_ret_stb_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#define qemu_st_lew(X) helper_le_stw_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#define qemu_st_lel(X) helper_le_stl_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#define qemu_st_leq(X) helper_le_stq_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#define qemu_st_bew(X) helper_be_stw_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#define qemu_st_bel(X) helper_be_stl_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#define qemu_st_beq(X) helper_be_stq_mmu(env, taddr, X, oi, (uintptr_t)tb_ptr)
#else
...
#if TCG_TARGET_REG_BITS == 32
            tmp64 = ((helper_function)t0)(
                tci_read_reg(regs, TCG_REG_R0), tci_read_reg(regs, TCG_REG_R1),
                tci_read_reg(regs, TCG_REG_R2), tci_read_reg(regs, TCG_REG_R3),
                tci_read_reg(regs, TCG_REG_R5), tci_read_reg(regs, TCG_REG_R6),
                tci_read_reg(regs, TCG_REG_R7), tci_read_reg(regs, TCG_REG_R8),
                tci_read_reg(regs, TCG_REG_R9), tci_read_reg(regs, TCG_REG_R10),
